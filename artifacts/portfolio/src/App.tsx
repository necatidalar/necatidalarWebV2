  ...
  return (
    <div className="bg-background min-h-screen text-foreground font-sans selection:bg-primary/30 selection:text-primary">
      ...
      >
        <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
          <div className="text-xl font-bold font-mono tracking-tighter text-white">
            <span className="text-primary">&lt;</span>ND
      ...
      <main>
        ...
        <section
          id="hero"
          className="min-h-[100dvh] flex items-center justify-center relative overflow-hidden px-6 pt-20"
        >
          ...
          <div className="container mx-auto max-w-5xl relative z-10 flex flex-col items-center text-center">
            ...
            >
              ...
              >
                Merhaba, ben <br className="md:hidden" />
              ...
              >
                <Button
                  size="lg"
                  className="text-base h-14 px-8 glow-primary"
                  onClick={() => scrollTo("projeler")}
                >
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="text-base h-14 px-8 border-white/10 hover:bg-white/5 hover:text-white"
                  onClick={() => scrollTo("iletisim")}
                >
                  {hero.btn2}
                </Button>
        ...
        <section
          id="hakkimda"
          className="py-24 md:py-32 px-6 relative border-t border-white/5 bg-card/30"
        >
            ...
            >
              ...
              >
                {about.skills.map((skill, index) => (
                  <div
                    key={index}
                    className="flex items-center space-x-3 bg-white/5 border border-white/5 p-4 rounded-xl"
                  >
        ...
        <section id="hizmetler" className="py-24 md:py-32 px-6 relative">
          <div className="container mx-auto max-w-6xl">
            ...
            >
              <h2 className="text-sm font-mono text-primary uppercase tracking-wider mb-3">
                Hizmetlerim
              </h2>
              <h3 className="text-3xl md:text-4xl font-bold text-white max-w-2xl">
                Fikrinizi hayata geçirecek teknik uzmanlık.
              </h3>
            </motion.div>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            >
              <div>
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-white max-w-2xl">
                  Son dönemde geliştirdiğim işler.
                </h3>
              </div>
              <Button
                variant="outline"
                className="border-white/10 hover:bg-white/5 group"
                onClick={() => window.open(contact.githubUrl, "_blank")}
              >
                Github'da İncele{" "}
                <Github className="ml-2 h-4 w-4 group-hover:text-primary transition-colors" />
              </Button>
            </motion.div>
                    ...
                    <div className="flex justify-between items-start mb-6">
                      <div className="flex gap-2">
                        <a
                          ...
                          className="text-muted-foreground hover:text-white transition-colors bg-white/5 p-2 rounded-full"
                        >
                          <Github className="h-5 w-5" />
                        </a>
                        <a
                          href={project.demoLink}
                          className="text-muted-foreground hover:text-primary transition-colors bg-white/5 p-2 rounded-full"
                        >
            ...
            <div className="grid lg:grid-cols-2 gap-16">
              ...
              >
                ...
                <h3 className="text-4xl md:text-5xl font-bold text-white mb-6">
                  Projelerinizi birlikte <br />
                  hayata geçirelim.
                </h3>
                <p className="text-lg text-muted-foreground mb-12 max-w-md">
                  Yeni bir proje fikriniz mi var veya mevcut projeniz için
                  desteğe mi ihtiyacınız var? Mesaj atın, üzerine konuşalım.
                </p>
        ...
        <div className="container mx-auto px-6 max-w-6xl flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a
              ...
              className="text-muted-foreground hover:text-[#0077b5] transition-colors p-2 hover:bg-white/5 rounded-full"
            >
